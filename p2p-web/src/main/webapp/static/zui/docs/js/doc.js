...
(function(window, $)
{
    ...
    var INDEX_JSON = 'static/zui/docs/index.json';
    var ICONS_JSON = 'static/zui/docs/icons.json';
    var PKG_JSON = 'static/zui/package.json';
    ...
    var displaySection = function() {
        ...
        if(eachSection(function(chapter, section, $sectionList){
            ...
            if(typeof url === 'undefined') {
                section.url = 'static/zui/docs/part/' + section.chapter + '-' + section.id + '.html';
                section.target = 'page';
                ...
                if(url === '.md') {
                    section.url = 'static/zui/docs/part/' + section.chapter + '-' + section.id + '.md';
                }
            } else {
                section.target = '';
            }
